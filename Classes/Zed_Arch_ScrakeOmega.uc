...
simulated static final function Zed_Arch_ScrakeOmega GetArch( WorldInfo Level )
{
	...
	foreach Level.DynamicActors(class'Zedternal.Zed_Arch_ScrakeOmega',A)
	{
	...
	{
		A = Level.Spawn(class'Zedternal.Zed_Arch_ScrakeOmega');
		return A;
	}
	return None;
}
...
defaultproperties
{
   zedServerArch=KFCharacterInfo_Monster'ZED_Omega.ZED_Scrake_Omega_Archetype'
