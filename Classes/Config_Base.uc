...
defaultproperties
{
	...
	ConfigFiles(21)=class'ZedternalReborn.Config_Map'

	//ZedternalReborn_Upgrades
	ConfigFiles(22)=class'ZedternalReborn.Config_PerkUpgrade'
	ConfigFiles(23)=class'ZedternalReborn.Config_PerkUpgradeOptions'
	ConfigFiles(24)=class'ZedternalReborn.Config_SkillReroll'
	ConfigFiles(25)=class'ZedternalReborn.Config_SkillUpgrade'
	ConfigFiles(26)=class'ZedternalReborn.Config_SkillUpgradeOptions'
	ConfigFiles(27)=class'ZedternalReborn.Config_WeaponUpgrade'
	ConfigFiles(28)=class'ZedternalReborn.Config_WeaponUpgradeOptions'
	ConfigFiles(29)=class'ZedternalReborn.Config_EquipmentUpgrade'

	//ZedternalReborn_Weapons
	ConfigFiles(30)=class'ZedternalReborn.Config_WeaponStarting'
	ConfigFiles(31)=class'ZedternalReborn.Config_WeaponGrenade'
	ConfigFiles(32)=class'ZedternalReborn.Config_WeaponStatic'
	ConfigFiles(33)=class'ZedternalReborn.Config_WeaponCustom'
	ConfigFiles(34)=class'ZedternalReborn.Config_WeaponVariant'
	ConfigFiles(35)=class'ZedternalReborn.Config_WeaponDisable'

	//ZedternalReborn_ZedWaves
	ConfigFiles(36)=class'ZedternalReborn.Config_WaveOptions'
	ConfigFiles(37)=class'ZedternalReborn.Config_WaveValue'
	ConfigFiles(38)=class'ZedternalReborn.Config_WaveSpawnRate'
	ConfigFiles(39)=class'ZedternalReborn.Config_Zed'
	ConfigFiles(40)=class'ZedternalReborn.Config_ZedValue'
	ConfigFiles(41)=class'ZedternalReborn.Config_ZedVariant'
	ConfigFiles(42)=class'ZedternalReborn.Config_ZedInject'
