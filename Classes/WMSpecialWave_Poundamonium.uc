...
defaultproperties
{
   ...
   MonsterToAdd(2)=(MinWave=0,MaxWave=999,MinGr=1,MaxGr=2,MClass=Class'KFGameContent.KFPawn_ZedClot_Alpha')
   MonsterToAdd(3)=(MinWave=12,MaxWave=999,MinGr=1,MaxGr=1,MClass=Class'Zedternal.WMPawn_ZedFleshpound_Omega')
