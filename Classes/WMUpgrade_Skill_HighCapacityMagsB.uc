...
defaultproperties
{
	...
	upgradeIcon(0)=Texture2D'Zedternal_Resource.Skills.UI_Skill_HighCapacityMagsB'
	upgradeIcon(1)=Texture2D'Zedternal_Resource.Skills.UI_Skill_HighCapacityMagsB_Deluxe'
}