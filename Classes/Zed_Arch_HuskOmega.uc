...
simulated static final function Zed_Arch_HuskOmega GetArch( WorldInfo Level )
{
	...
	foreach Level.DynamicActors(class'Zedternal.Zed_Arch_HuskOmega',A)
	{
	...
	{
		A = Level.Spawn(class'Zedternal.Zed_Arch_HuskOmega');
		return A;
	}
	return None;
}
...
defaultproperties
{
   zedServerArch=KFCharacterInfo_Monster'ZED_Omega.ZED_Husk_Omega_Archetype'
