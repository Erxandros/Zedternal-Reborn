...
simulated static final function Zed_Arch_SirenOmega GetArch( WorldInfo Level )
{
	...
	foreach Level.DynamicActors(class'ZedternalReborn.Zed_Arch_SirenOmega',A)
	{
	...
	{
		A = Level.Spawn(class'ZedternalReborn.Zed_Arch_SirenOmega');
		return A;
	}
	return None;
}
...
defaultproperties
{
   zedServerArch=KFCharacterInfo_Monster'ZedternalReborn_Zeds.ZED_Siren_Omega_Archetype'
