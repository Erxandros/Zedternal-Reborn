...
simulated static final function Zed_Arch_SlasherOmega GetArch( WorldInfo Level )
{
	...
	foreach Level.DynamicActors(class'Zedternal.Zed_Arch_SlasherOmega',A)
	{
	...
	{
		A = Level.Spawn(class'Zedternal.Zed_Arch_SlasherOmega');
		return A;
	}
	return None;
}
...
defaultproperties
{
   zedServerArch=KFCharacterInfo_Monster'ZED_Omega.ZED_Clot_Slasher_Omega_Archetype'
