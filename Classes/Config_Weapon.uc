...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < 2)
	{
		...
		default.WeaponVariant_VariantList[35].WeaponDefVariant = "ZedternalReborn.WMWeapDef_FlareGun_Precious";
		default.WeaponVariant_VariantList[35].DualWeaponDefVariant = "ZedternalReborn.WMWeapDef_FlareGunDual_Precious";
		default.WeaponVariant_VariantList[36].WeaponDef = "KFGame.KFWeapDef_Colt1911";
		default.WeaponVariant_VariantList[36].WeaponDefVariant = "ZedternalReborn.WMWeapDef_Colt1911_Precious";
		default.WeaponVariant_VariantList[36].DualWeaponDefVariant = "ZedternalReborn.WMWeapDef_Colt1911Dual_Precious";
		default.WeaponVariant_VariantList[37].WeaponDef = "KFGame.KFWeapDef_Deagle";
		default.WeaponVariant_VariantList[37].WeaponDefVariant = "ZedternalReborn.WMWeapDef_Deagle_Precious";
		default.WeaponVariant_VariantList[37].DualWeaponDefVariant = "ZedternalReborn.WMWeapDef_DeagleDual_Precious";
		default.WeaponVariant_VariantList[38].WeaponDef = "KFGame.KFWeapDef_SW500";
		default.WeaponVariant_VariantList[38].WeaponDefVariant = "ZedternalReborn.WMWeapDef_SW500_Precious";
		default.WeaponVariant_VariantList[38].DualWeaponDefVariant = "ZedternalReborn.WMWeapDef_SW500Dual_Precious";
		default.WeaponVariant_VariantList[39].WeaponDef = "KFGame.KFWeapDef_AF2011";
		default.WeaponVariant_VariantList[39].WeaponDefVariant = "ZedternalReborn.WMWeapDef_AF2011_Precious";
		default.WeaponVariant_VariantList[39].DualWeaponDefVariant = "ZedternalReborn.WMWeapDef_AF2011Dual_Precious";
	...
	if (default.MODEVERSION < 10)
	{
		...
		tempObj.WeaponDefVariant = "ZedternalReborn.WMWeapDef_Mac10_Precious";
		default.WeaponVariant_VariantList.AddItem(tempObj);
		
		tempObj.WeaponDef = "KFGame.KFWeapDef_CenterfireMB464";
		tempObj.WeaponDefVariant = "ZedternalReborn.WMWeapDef_CenterfireMB464_Precious";
		default.WeaponVariant_VariantList.AddItem(tempObj);
		
		tempObj.WeaponDef = "KFGame.KFWeapDef_FreezeThrower";
		tempObj.WeaponDefVariant = "ZedternalReborn.WMWeapDef_FreezeThrower_Precious";
		default.WeaponVariant_VariantList.AddItem(tempObj);
		
		// force weapon variant for nailgun
		tempObj.WeaponDef = "KFGame.KFWeapDef_NailGun";
		tempObj.WeaponDefVariant = "ZedternalReborn.WMWeapDef_NailGun";
