class Config_Weapon extends Config_Common
...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < 3)
	{
		...
		newVariant.WeaponDef = "KFGame.KFWeapDef_Blunderbuss";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_Blunderbuss_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
	...
	if (default.MODEVERSION < 6)
	{
		...
		newVariant.WeaponDef = "KFGame.KFWeapDef_Mine_Reconstructor";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_Mine_Reconstructor_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
		...
		newVariant.WeaponDef = "KFGame.KFWeapDef_HRGScorcher";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_HRGScorcher_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
	...
	if (default.MODEVERSION < 7)
	{
		...
		newVariant.WeaponDef = "KFGame.KFWeapDef_Rifle_FrostShotgunAxe";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_Rifle_FrostShotgunAxe_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
	...
	if (default.MODEVERSION < 8)
	{
		...
		newVariant.WeaponDef = "KFGame.KFWeapDef_HRG_SonicGun";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_HRG_SonicGun_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);

		newVariant.WeaponDef = "KFGame.KFWeapDef_GravityImploder";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_GravityImploder_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
	...
	if (default.MODEVERSION < 9)
	{
		...
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_FAMAS_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);

		newVariant.WeaponDef = "KFGame.KFWeapDef_HRG_BarrierRifle";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_HRG_BarrierRifle_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);

		newVariant.WeaponDef = "KFGame.KFWeapDef_HRG_BlastBrawlers";
		newVariant.WeaponDefVariant = "ZedternalReborn.WMWeapDef_HRG_BlastBrawlers_Precious";
		newVariant.DualWeaponDefVariant = "";
		default.WeaponVariant_VariantList.AddItem(newVariant);
