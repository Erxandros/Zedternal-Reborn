...
defaultproperties
{
	...
	DamageHead=0.050000
	Recoil=0.100000
	upgradeIcon(0)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_0'
	upgradeIcon(1)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_1'
	upgradeIcon(2)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_2'
	upgradeIcon(3)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_3'
	upgradeIcon(4)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_4'
	upgradeIcon(5)=Texture2D'Zedternal_Resource.Perks.UI_Perk_Sharpshooter_Rank_5'
}