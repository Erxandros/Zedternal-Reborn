...
defaultproperties
{
   ...
   MonsterToAdd(2)=(MinWave=3,MaxWave=20,MinGr=1,MaxGr=5,MClass=Class'KFGameContent.KFPawn_ZedStalker')
   MonsterToAdd(3)=(MinWave=3,MaxWave=999,MinGr=1,MaxGr=2,MClass=Class'KFGameContent.KFPawn_ZedGorefast')
   MonsterToAdd(4)=(MinWave=0,MaxWave=999,MinGr=1,MaxGr=4,MClass=Class'KFGameContent.KFPawn_ZedGorefast')
   ...
   MonsterToAdd(7)=(MinWave=3,MaxWave=17,MinGr=1,MaxGr=5,MClass=Class'KFGameContent.KFPawn_ZedStalker')
   MonsterToAdd(8)=(MinWave=3,MaxWave=999,MinGr=1,MaxGr=4,MClass=Class'KFGameContent.KFPawn_ZedGorefast')
