...
var config array<SZedWave> Zed_Wave;
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Zed_Wave[40].ZedClass = class'KFGameContent.KFPawn_ZedFleshpoundMini';
		default.Zed_Wave[40].MinWave = 4;
		default.Zed_Wave[40].MaxWave = 10;
		default.Zed_Wave[40].MinGr = 1;
		default.Zed_Wave[40].MaxGr = 1;

		default.Zed_Wave[41].ZedClass = class'KFGameContent.KFPawn_ZedFleshpoundMini';
		...
		default.Zed_Wave[55].ZedClass = class'KFGameContent.KFPawn_ZedDAR_Rocket';
		default.Zed_Wave[55].MinWave = 9;
		default.Zed_Wave[55].MaxWave = 999;
		default.Zed_Wave[55].MinGr = 1;
		default.Zed_Wave[55].MaxGr = 1;

		default.Zed_Wave[56].ZedClass = class'KFGameContent.KFPawn_ZedBloatKingSubspawn';
