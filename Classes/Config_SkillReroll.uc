...
static function CheckConfigValues()
{
	...
	{
		`log("ZR Warning: SkillReroll_BasePrice is set to" @ default.SkillReroll_BasePrice @ "which is not supported. Setting the price to 0 (free)."
			@"Please change the value to a value greater than or equal to 0 (free).");
		default.SkillReroll_BasePrice = 0;
	}

	if (default.SkillReroll_NextRerollPriceMultiplier < 1.0f)
	{
		`log("ZR Warning: SkillReroll_NextRerollPriceMultiplier is set to" @ default.SkillReroll_NextRerollPriceMultiplier @ "which is not supported."
			@"Setting the price multiplier to 1.0. Please change the value to a value greater than or equal to 1.0.");
		default.SkillReroll_NextRerollPriceMultiplier = 1.0f;
	}

	if (default.SkillReroll_SkillRerollSellPercentage < 0.0f)
	{
		`log("ZR Warning: SkillReroll_SkillRerollSellPercentage is set to" @ default.SkillReroll_SkillRerollSellPercentage @ "which is not supported."
			@"Setting the sell percentage to 0.0 (0%), please change the value to a value between 0.0 (0%) and 1.0 (100%).");
	...
	{
		`log("ZR Warning: SkillReroll_SkillRerollSellPercentage is set to" @ default.SkillReroll_SkillRerollSellPercentage @ "which is not supported."
			@"Setting the sell percentage to 1.0 (100%), please change the value to a value between 0.0 (0%) and 1.0 (100%).");
